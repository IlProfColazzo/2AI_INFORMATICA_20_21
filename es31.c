//Munitello Lorenzo 2AI

/*Riscrivi l'esercizio n°30 utilizzando il tipo int 
...
{
    int num1, num2, num3;
    printf("Valore del primo numero reale: ", num1);
    scanf("%d", &num1);
    printf("Valore del secondo numero reale: ", num2);
    scanf("%d", &num2);
    printf("Valore del terzo numero reale: ", num3);
    scanf("%d", &num3);
